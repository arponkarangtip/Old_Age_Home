...
<tr>
<th>Accessibility to OAHM Committee members </th>
...
<tr>
<th>Old Age Home Surroundings (eg Lawn etc.) </th>
...
<div class="form-group">
<label class="col-sm-4 control-label">Accessibility to OAHM Committee members</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-4 control-label">Old Age home Surroundings (eg Lawn etc.) </label>
<div class="col-sm-8">
...
<?php }} else {?>
	<div>You are not eligible for Feedback. Once you book the old age, you will be eligible for feedback.</div>
<?php }?>
									</div>
									</div>
								</div>
