<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="registration.php"><i class="fa fa-user"></i>Resident Registration</a></li>
				<li><a href="manage-students.php"><i class="fa fa-users"></i>Manage Resident</a></li>
				<li><a href="meal.php"><i class="fa fa-users"></i>Meal Management</a></li>
				<li><a href="report.php"><i class="fa fa-users"></i>Reports</a></li>
				<li><a href="analytics.php"><i class="fa fa-users"></i>Analytics</a></li>
