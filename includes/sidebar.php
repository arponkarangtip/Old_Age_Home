...
<li><a href="book-hostel.php"><i class="fa fa-file-o"></i>Book Resident Details</a></li>
...
<li><a href="review_user.php"><i class="fa fa-files-o"></i> User Review </a></li>
...
<?php } else { ?>
				<li><a href="index.php"><i class="fa fa-files-o"></i> Login</a></li>
